...
export default function NewWorkingOwnerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log('🚀 WORKING VERSION - Direct API call', new Date().toISOString())
  ...
  return (
    <div className="container mx-auto py-6 px-4">
      ...
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          <CardTitle>🏠 Új tulajdonos regisztrálása (MŰKÖDŐ VERZIÓ)</CardTitle>
          <p className="text-sm text-muted-foreground mt-2">
            Ez a form a standalone API-t használja, ami bizonyítottan működik
          </p>
        </CardHeader>
        <CardContent>
          {success && (
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            <p className="text-sm text-blue-800">
              💡 <strong>Ez a működő verzió!</strong> A standalone API-t használja, 
              ami megkerüli az összes tRPC és cache problémát.
            </p>
          </div>
        </CardContent>
      </Card>
