...
export default function EditContractTemplatePage() {
  ...
  const updateMutation = api.contractTemplate.update.useMutation({
    onSuccess: () => {
  ...
  return (
    <div className="container mx-auto py-6 max-w-4xl">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold">Sablon szerkesztése</h1>
        <p className="text-muted-foreground">Módosítsa a szerződés sablont</p>
      </div>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                render={({ field }) => (
                  <FormItem className="flex items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>
                        Az inaktív sablonok nem választhatók ki új szerződések létrehozásakor
                      </FormDescription>
                    </div>
                    <FormControl>
                      <Switch
          ...
          <div className="flex justify-end gap-4">
            ...
            <Button type="submit" disabled={isSubmitting || template.isSystem}>
              {isSubmitting ? (
                <>
